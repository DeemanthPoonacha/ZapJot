...
export default function ExplorePage() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "itinerary" | "journal">("all");
  ...
  const handleImportItinerary = async (e: React.MouseEvent, share: PublicShare) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  return (
    <PageLayout headerProps={{ title: "Community Explore Hub" }}>
      <div className="space-y-6 max-w-6xl mx-auto pb-12">
        {/* Banner Section */}
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-purple-900 via-indigo-900 to-slate-900 p-6 sm:p-10 text-white shadow-xl border border-white/10">
          ...
          <div className="relative z-10 space-y-3 max-w-2xl">
            ...
            <p className="text-purple-200/90 text-sm sm:text-base leading-relaxed">
              Discover hand-crafted travel guides, trip itineraries, and journal entries shared by the ZapJot community. Import itineraries into your planner with one click!
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-card rounded-2xl border border-border p-8 space-y-3">
            ...
            <h3 className="text-lg font-bold text-foreground">No Shared Items Found</h3>
